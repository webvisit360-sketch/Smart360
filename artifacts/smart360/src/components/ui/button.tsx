...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-[14px] text-[16px] font-[700] ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 btn-3d",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "px-[20px] py-[12px] h-auto",
        sm: "h-10 rounded-lg px-4 text-xs font-semibold",
